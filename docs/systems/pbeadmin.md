...
| Выпуск | Технический директор применяет релиз-тег к прод-окружению и контролирует конфигурации |
| Хотфикс | Применяется напрямую на PROD ([разбор беклога](../regulations/support-process.md)) |
| Дефект до прода | `BUGREPORTS`, заводит тестировщик ([этап 11](../regulations/crm-lifecycle/11-testirovanie-i-revju.md)) |
