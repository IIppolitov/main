...
PROFILES=(
  ...
  "pbe|pbesql06p|Powbee, прод: внутренняя админка и прод консоли"
  "vlt|91.107.87.131|Валента, прод"
  "vlt-qa|212.8.235.60|Валента, тест (на сервере дев-среды)"
  "vltuz|185.8.212.245|Валента Узбекистан, прод"
  "vltkz|82.200.129.173|Валента Казахстан, прод"
  ...
  "pfz-qa|172.20.17.37,14333|Пфайзер, QA (пресейл; мнемоника не утверждена)"
)
